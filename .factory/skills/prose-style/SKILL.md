---
name: "prose-style"
description: "Anti-AI-smell rules for narrative prose: punctuation, sentence variation, transitions, word choice"
---
...
- **Be economical.** If a sentence works without a word, cut the word. Prefer short punches over compound clauses joined by commas.
...
- **Limit "landscape/ecosystem/paradigm" language.** These words have become AI markers. Use them only when the technical meaning is precise.
- **Cut fluff phrases.** "It's worth noting that," "in terms of," "the fact that" — these pad word count without adding meaning. Find the verb. Say it.
...
- **Write as the author, not a commentator.** AI defaults to observational distance ("one might argue," "it could be said"). State positions directly.
...
- **Avoid the "to be sure" sandwich.** Stating a counterpoint only to immediately dismiss it reads as performative balance. Either engage the counterpoint seriously or omit it.
- **Lists vs. narrative.** Default to narrative prose. Use bulleted lists only for genuinely enumerable items. A blog post with more than one bulleted list probably needs restructuring.
