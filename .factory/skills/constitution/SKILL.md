...
name: constitution
description: >
  Generate project governance documents: CONSTITUTION.md (principles, Definition
  of Done, quality gates) and WORKFLOWS.md (lifecycle phases). Use when starting
  a new project or formalizing how a team works. Invoke with /constitution.
...
If no README exists, ask the parent agent for: project name, mission (one sentence), and primary domain.
